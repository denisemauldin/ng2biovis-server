...
class VitalsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vital" do
    assert_difference('Vital.count') do
      post vitals_url, params: { vital: { bloodpressure: @vital.bloodpressure, heartrate: @vital.heartrate, name: @vital.name, temperature: @vital.temperature } }
    end
  ...
  test "should update vital" do
    patch vital_url(@vital), params: { vital: { bloodpressure: @vital.bloodpressure, heartrate: @vital.heartrate, name: @vital.name, temperature: @vital.temperature } }
